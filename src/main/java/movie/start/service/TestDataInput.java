...
public class TestDataInput {
    ...
    public void InputData(){
        ...
        //예매한 티켓의 좌석 예매하기
        ticketSeatDAO.createTicketSeat(ticket1, th1seats[0]);
        ticketSeatDAO.createTicketSeat(ticket1, th1seats[1]);
        ticketSeatDAO.createTicketSeat(ticket2, th1seats[2]);
        ticketSeatDAO.createTicketSeat(ticket2, th1seats[3]);
    }
}
